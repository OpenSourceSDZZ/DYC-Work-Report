<template>
    <div id="top">
        ...
        <t-table row-key="0" :columns="columns" :data="tableData" :selected-row-keys="selectedRowKeys"
            @select-change="rehandleSelectChange" :pagination="
            {
                defaultCurrent: 1,
                defaultPageSize: 20,
...
const columns = [
    ...
    { colKey: '0', title: 'ID', align: 'center', width: 50 },
    {
        colKey: '3',
        title: '姓名',
        width: 50,
    },
    { colKey: '1', title: '用户Code', width: 50 },
    { colKey: '2', title: '班级', align: 'left', width: 50 },
    {
        colKey: 'do',
        width: 400,
        title: '操作',
